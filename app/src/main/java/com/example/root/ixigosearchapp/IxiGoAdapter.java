...
public class IxiGoAdapter<S, T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public IxiGoAdapter(Context context, List<S> objects, BindAdapterListener listener, Class<T> holderClass, int layoutId) {
        mContext = context;
        mObjects = objects;
